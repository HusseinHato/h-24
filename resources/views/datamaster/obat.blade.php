            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger">Habis <span class="badge"></span></button>
                    </td>
                  </tr>
              <tr>
                <td>2.</td>
                ...
                <td>
                    {{-- <a href="" class="btn btn-link text-info" data-toggle="modal" data-target="#editpasien"><i class="fas fa-edit"></i> Edit</a>
                    <button  class="btn btn-link text-danger"><i class="fas fa-trash"></i>  Delete</button> --}}
                    <button type="button" class="btn btn-success">Belum Habis <span class="badge"></span></button>
                </td>
              </tr>
              <tr>
                <td>3.</td>
