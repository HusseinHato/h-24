...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Pegawai Pasien</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">Home</a></li>
              <li class="breadcrumb-item active">Data Pegawai Pasien</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="col-12">
    <div class="card">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Pegawai - Pasien</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>21-1-21</td>
                <td>
                    <a href="" class="btn btn-link text-info" data-toggle="modal" data-target="#editpepas"><i class="fas fa-edit"></i> Edit</a>
...
<!-- Modal Pegawai -->
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <select class="custom-select">
                            <option>Pegawainya</option>
                            <option>Pegawai itu</option>
                          </select>
                    </div>
                    <div class="col-6">
  ...
  <!-- Modal Pegawai -->
  <div class="modal fade" id="editpepas">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
...
<!-- /.card -->
  ...
  <!--
    ...
    PEGAWAII YANG MEMEGANG BERAPA PASIENN
...
<div class="col-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Pegawai - Total Pasien</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <table class="table table-bordered">
